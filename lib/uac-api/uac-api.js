...
function get_md5_details(md5, callback) {
    ...
    if (url_base && auth_key) {
        // An authentication key is specified.
        ...
        // No m-cube base url or authentication key is specified, bypass the call.
        callback();
    }
}
