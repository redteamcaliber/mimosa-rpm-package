...
//if (options.params) {
//    local_options.url = options.url + '?' + querystring.stringify(options.params);
//}
//else {
//    local_options.url = options.url;
//}
                ...
                try {
                    ...
                    request_api(options, function (err, response, body) {
                        ...
                        if (err) {
                            ...
                            callback(_.sprintf('Unknown error while invoking url: %s %s', options.method, url));
                        }
